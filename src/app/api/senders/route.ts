...
export async function POST(request: Request) {
  try {
    ...
    const { name, email, app_password, service = 'gmail', smtp_host = 'smtp.gmail.com', smtp_port = 587, smtp_user, daily_limit = 500 } = body;
    ...
    const query = `
      INSERT INTO email_senders (name, email, app_password, service, smtp_host, smtp_port, smtp_user, daily_limit)
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      RETURNING *
    `;
    const params = [name, email, app_password, service, smtp_host, smtp_port, smtp_user || email, daily_limit];
